...
export async function POST(
  ...
  if (survey.survey_type === "jigyotai") {
    // Jigyotai: filter by respondent_type
    ...
    // Clinic: no respondent_type filter
  ...
  const includeRespondentName = respondentType === "staff";
  ...
  for (const resp of result.responses) {
    await submitResponse({
      ...
      respondentName: includeRespondentName ? (resp.respondentName ?? undefined) : undefined,
