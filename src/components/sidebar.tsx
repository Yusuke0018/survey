...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-[260px] bg-white border-r border-[#E5E7EB] flex flex-col z-40">
      {/* Logo */}
      ...
      {surveyType === "jigyotai" && (
        <div className="px-5 py-2 bg-[#F0FDF4] border-b border-[#E5E7EB]">
          <span className="text-[10px] font-semibold text-[#059669]">事業体サーベイモード</span>
        </div>
      )}
      ...
      <nav className="flex-1 py-4 overflow-y-auto">
        <div className="px-5 mb-2">
          <span className="text-[11px] font-semibold text-[#9CA3AF] uppercase tracking-wider">分析</span>
        </div>
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <span className={cn(isActive ? "text-[#10B981]" : "text-[#9CA3AF]")}>{item.icon}</span>
        ...
        <div className="px-5 mt-6 mb-2">
          <span className="text-[11px] font-semibold text-[#9CA3AF] uppercase tracking-wider">管理</span>
        </div>
        {adminItems.map((item) => {
      ...
      <div className="p-4 border-t border-[#E5E7EB]">
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-sm text-[#6B7280] hover:bg-[#FEF2F2] hover:text-[#DC2626] transition-all"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
